...
1. Créer une session d’estimation

2. Rejoindre une session via un code unique

3. Voter secrètement grâce aux cartes du Planning Poker

4. Révéler les votes simultanément

5. Détecter automatiquement l'unanimité ou le besoin de discussion

6. Utiliser un chat en direct pour échanger en cas de désaccord

7. Le facilitateur peut valider l’estimation finale

8. Gestion complète des stories, du backlog et des participants
